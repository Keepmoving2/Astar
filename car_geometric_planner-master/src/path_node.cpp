...
double start_state[3] = {2, 0, M_PI / 4};
double final_state[3] = {2, -6, -M_PI / 2 - 0 / 180.0 * M_PI};
...
int main(int argc, char **argv) {
    ...
    // 初始化杜宾斯参数和reeds_sheep曲线
    double steer_radius = 2.0;
    ...
    while (nh.ok()) {
        ...
        std::cout << "rs path length: " << rs_path.size() << std::endl;
        ...
        rs_path_msg.header.frame_id = "world";
        ...
        std::cout << "db_path size: " << db_path.size() << std::endl;
        // for(int i = 0; i < db_path.size(); ++i) {
        //     std::cout << "db_path kappa: " << db_path[i][3] << std::endl;
        // }
        ...
        db_path_msg.header.frame_id = "world";
